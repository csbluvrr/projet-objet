...
$adminCin = $_SESSION['admin_cin'];
$adminEmail = $_SESSION['admin_email'];
$adminLastname = $_SESSION['admin_lastname'];
$adminFirstname = $_SESSION['admin_firstname'];
$adminNum = $_SESSION['admin_num'];
...
<body>
    ...
    <div class="info-container">
        <h2>Welcome, <?= htmlspecialchars($adminFirstname . ' ' . $adminLastname) ?>!</h2>
    ...
    <div class="container">
        ...
        <div class="button-container">
            <a href="admin_list.php" class="btn">View Admins</a>
            <a href="doctor_list.php" class="btn">View Doctors</a>
            <a href="patient_list.php" class="btn">View Patients</a>
            <a href="rendezvous_list.php" class="btn">View Appointments</a>
        </div>
    </div>
